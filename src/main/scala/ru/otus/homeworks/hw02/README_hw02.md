...
## Цель:
### Научиться практическому использованию наиболее употребляемых методов работы с данными и немного вспомнить математику (теорию вероятности), ввиду того, что скалу очень часто применяют для анализа данных, то это будет полезно.
